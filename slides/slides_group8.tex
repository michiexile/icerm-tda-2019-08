...
\begin{frame}
\begin{itemize}
\item \textbf{Theorem} (\textit{Circular Coordinates}): Given a $[f]\in H^{1}(\mathbb{Z})$, $f$ can
...
\begin{center}
\includegraphics[scale=0.33]{pasted4} \includegraphics[scale=0.33]{pasted6}\\
\end{center}
\end{itemize}
\end{frame}
%
...
\begin{itemize}
	...
	\begin{center}
		\includegraphics[scale=0.5]{thin_anulus_l2}\includegraphics[scale=0.5]{thin_anulus_l1}\\
	\end{center}
\end{itemize}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.66]{pasted10}
\end{center}
\end{itemize}
\end{frame}
